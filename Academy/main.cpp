...
public:
	...
	void set_attendace(double attendance)
	{
...
class Graduate :public Student
{
	std::string subject;
public:
	Graduate(HUMAN_TAKE_PARAMETRES, STUDENT_TAKE_PARAMETERS, const std::string& subject)
		:Student(HUMAN_GIVE_PARAMETRES, STUDENT_GIVE_PARAMETERS)
	{
